...
var SimpleCore = {
    ...
    init: function (params) {
        ...
        $(document).on('click', '.btn-thumbs-up', function (e) {
            ...
            if (SimpleCore.donateImg != '') {
                SimpleCore.alert('感谢您的支持','<img style="width:180px;background:#fff;" src="' + SimpleCore.donateImg + '">');
            } else {
                SimpleCore.alert('未开通自定义功能','<h4 style="text-align: center;margin: 0">联系博主试试看 ：）</h4>');
            }
        });
    ...
    changeReadModel: function () {
        ...
        if (SimpleCore.getLocalData('read-mode') == 'night') {
            ...
            $(".cover-img").css({
                'background': "url('/images/cover-night.png')",
                'background-image': '/images/cover-night.png',
            ...
            $(".cover-img").css({
                'background': "url('/images/cover-day_1.jpg')",
                'background-image': '/images/cover-day_1.jpg',
                'background-size': 'cover',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
